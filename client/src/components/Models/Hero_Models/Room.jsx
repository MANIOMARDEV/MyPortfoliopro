...
export function Room(props) {
  const { nodes, materials } = useGLTF(resolveAssetPath("/models/optimized-room.glb"));
  const screensRef = useRef();
  const matcapTexture = useTexture(resolveAssetPath("/images/textures/mat1.png"));
...
useGLTF.preload(resolveAssetPath("/models/optimized-room.glb"));